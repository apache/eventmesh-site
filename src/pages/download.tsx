...
const releaseList: Release[] = [
  {
    ...
    notes: 'https://eventmesh.apache.org/events/release-notes/v1.12.0',
    source: {
      tar: 'https://www.apache.org/dyn/closer.lua/eventmesh/1.12.0/apache-eventmesh-1.12.0-source.tar.gz',
      asc: 'https://downloads.apache.org/eventmesh/1.12.0/apache-eventmesh-1.12.0-source.tar.gz.asc',
      sha512: 'https://downloads.apache.org/eventmesh/1.12.0/apache-eventmesh-1.12.0-source.tar.gz.sha512',
    },
    binary: {
      tar: 'https://www.apache.org/dyn/closer.lua/eventmesh/1.12.0/apache-eventmesh-1.12.0-bin.tar.gz',
      asc: 'https://downloads.apache.org/eventmesh/1.12.0/apache-eventmesh-1.12.0-bin.tar.gz.asc',
      sha512: 'https://downloads.apache.org/eventmesh/1.12.0/apache-eventmesh-1.12.0-bin.tar.gz.sha512',
    },
  },
  {
    version: 'v1.11.0',
  ...
  },
  {
    ...
    source: {
      tar: 'https://www.apache.org/dyn/closer.lua/eventmesh/1.10.0/apache-eventmesh-1.10.0-source.tar.gz',
      asc: 'https://downloads.apache.org/eventmesh/1.10.0/apache-eventmesh-1.10.0-source.tar.gz.asc',
      sha512: 'https://downloads.apache.org/eventmesh/1.10.0/apache-eventmesh-1.10.0-source.tar.gz.sha512',
    },
    binary: {
      tar: 'https://www.apache.org/dyn/closer.lua/eventmesh/1.10.0/apache-eventmesh-1.10.0-bin.tar.gz',
      asc: 'https://downloads.apache.org/eventmesh/1.10.0/apache-eventmesh-1.10.0-bin.tar.gz.asc',
      sha512: 'https://downloads.apache.org/eventmesh/1.10.0/apache-eventmesh-1.10.0-bin.tar.gz.sha512',
    },
  },
  {
    version: 'v1.9.0',
