...
在 [EventMesh download](https://eventmesh.apache.org/download) 页面选择 1.5.0 版本的 Source Code 进行下载并解压，您将获得**apache-eventmesh-1.5.0-incubating-src**
...
在 [EventMesh download](https://eventmesh.apache.org/download) 页面选择 1.5.0 版本的 Binary Distribution 进行下载，您将获得**apache-eventmesh-1.5.0-incubating-bin.tar.gz**
