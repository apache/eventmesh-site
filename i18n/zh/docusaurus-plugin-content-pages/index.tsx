...
const javaCode = `<span class="com">// 发布 CloudEvent</span>
...
client.publish(event);  <span class="com">// 🚀 事件已发布！</span>`;

const pythonCode = `<span class="com"># 发布 CloudEvent</span>
...
client.<span class="fn">publish</span>(event)  <span class="com"># 🚀 事件已发布！</span>`;

const goCode = `<span class="com">// 发布 CloudEvent</span>
          ...
          <div className="arch-diagram reveal">
            <div className="arch-layers">
              <div className="arch-layer">
                <div className="arch-layer-label">应用层</div>
                <div className="arch-layer-content">
                  <div className="arch-node">微服务</div>
                  <div className="arch-node">Serverless 函数</div>
                  <div className="arch-node">AI Agent</div>
                  <div className="arch-node">IoT 设备</div>
                </div>
              </div>

              <div className="arch-flow">▼ 协议 ▼</div>

              <div className="arch-layer">
                <div className="arch-layer-label">协议层</div>
                <div className="arch-layer-content">
              ...
              <div className="arch-flow">▼ 事件流 ▼</div>

              <div className="arch-layer">
                <div className="arch-layer-label">EventMesh 运行时</div>
                <div className="arch-layer-content">
                  <div className="arch-node core">事件网关</div>
                  <div className="arch-node core">事件路由</div>
                  <div className="arch-node core">工作流引擎</div>
                  <div className="arch-node core">Schema 注册中心</div>
                </div>
              </div>

              <div className="arch-flow">▼ 事件存储 ▼</div>

              <div className="arch-layer">
                <div className="arch-layer-label">事件存储</div>
                <div className="arch-layer-content">
          ...
          <div className="a2a-grid">
            <div className="reveal">
              ...
              <div style={{marginTop: '32px'}}>
                <a href="/zh/docs/a2a-protocol" className="btn btn-primary">
                  探索 A2A 文档
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </a>
              </div>
      ...
      <section className="section" id="ecosystem">
        <div className="container">
          <div className="reveal">
            ...
            <p className="section-subtitle">
              开箱即用 23 个连接器。EventMesh 与你现有的基础设施无缝集成 —
              无需推倒重来。
            </p>
          </div>
          ...
          <div className="eco-bus reveal">
            <div className="eco-box eco-source-box">
              <div className="eco-box-title">Source 连接器</div>
            ...
            <div className="eco-arrow-block">
              <svg className="eco-arrow-svg" viewBox="0 0 80 120" preserveAspectRatio="xMidYMid meet">
                <defs>
                  <marker id="em-arrow-r-zh" markerWidth="10" markerHeight="8" refX="10" refY="4" orient="auto">
                    <polygon points="0 0, 10 4, 0 8" fill="var(--em-green)"/>
                  </marker>
                </defs>
                <line x1="10" y1="60" x2="68" y2="60" stroke="var(--em-green)" strokeWidth="2.5" strokeLinecap="round" markerEnd="url(#em-arrow-r-zh)"/>
              </svg>
            </div>
            ...
            <div className="eco-hub">
              ...
              <div className="eco-hub-tag">事件总线</div>
            </div>

            <div className="eco-arrow-block">
              <svg className="eco-arrow-svg" viewBox="0 0 80 120" preserveAspectRatio="xMidYMid meet">
                <line x1="12" y1="60" x2="70" y2="60" stroke="var(--em-green)" strokeWidth="2.5" strokeLinecap="round" markerEnd="url(#em-arrow-r-zh)"/>
              </svg>
            </div>

            <div className="eco-box eco-sink-box">
              <div className="eco-box-title">Sink 连接器</div>
              <div className="eco-box-grid">
