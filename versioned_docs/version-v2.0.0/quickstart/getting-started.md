...
[client guide](../feature/client-java.md) for the trade-offs.
...
- [Client guide](../feature/client-java.md) — complete SDK walkthrough
- [Production readiness](../feature/deployment.md) — verified capabilities, SLOs, runbooks
